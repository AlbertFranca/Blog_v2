...
public class ArtigoLocalService {
    ...
    public void deletArtigo(int id)
    ...
    public Artigo atualizaArtigo(int id, String titulo, String autor, Date data, String texto)
        throws ArtigoInexistenteException{
            ...
            try {
                ...
                //artigo.setDate(ArtifoHelper.converterStringParaDate(ArtigoDTO.getData()));
                artigo.setDate(data);
